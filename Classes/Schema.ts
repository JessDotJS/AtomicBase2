...
export class Schema {
    ...
    public atomicPriority: AtomicPriority;
    public primary: Schema;
    public secondary: Schema;
    public foreign: Schema;

    constructor(schema: Schema, atomicPriority: AtomicPriority) {
        if (schema != undefined && schema != null){
            ...
            throw new Error("There was an error in your schema object. Schema couldn't initialize.");
        }
    }
